...
<body>
<h3>Click the center of the 16 regions on the map exactly as they correspond to regions p1 to p16:</h3>
<p>There are no names on the map, only numbers by the crossroads and the regions that border them. Please click the regions in the same order you conceptually mapped them when making the rules, from p1 to p16.</p>
